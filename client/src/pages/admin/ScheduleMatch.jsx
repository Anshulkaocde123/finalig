                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="relative py-6">
                            <div className="flex items-center justify-center gap-4">
                                <motion.div className="flex-1 text-center p-4 rounded-xl bg-blue-500/10 border border-blue-500/30" animate={{ borderColor: formData.teamA ? 'rgba(59, 130, 246, 0.5)' : 'rgba(59, 130, 246, 0.2)' }}>
                                ...
                                <motion.div className="flex-1 text-center p-4 rounded-xl bg-pink-500/10 border border-pink-500/30" animate={{ borderColor: formData.teamB ? 'rgba(236, 72, 153, 0.5)' : 'rgba(236, 72, 153, 0.2)' }}>
                        ...
                        {formData.sport === 'CRICKET' && (
                            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
                        ...
                        {['BADMINTON', 'TABLE_TENNIS', 'VOLLEYBALL'].includes(formData.sport) && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-xl">
                        ...
                        {['FOOTBALL', 'BASKETBALL', 'KHOKHO', 'KABADDI'].includes(formData.sport) && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl">
                        ...
                        {formData.teamA === formData.teamB && formData.teamA && (
                            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl flex gap-3">
